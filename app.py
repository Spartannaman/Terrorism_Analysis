...
# defining your function load_data
def load_data():
    dataset_name = "global_terror.csv"
    
    #pd.options.mode.chained_assignment = None       #Hide Warnings given by pandas 
...
def open_browser():
    # Opens the default broswer within a tab
...
def update_app_ui(month_value, date_value, region_value, country_value, state_value, city_value, attack_value, year_value, Tabs, chart_year_selector, chart_dp_value, search, subtabs2):
...
def main():
    ...
    print("Project successfully ended ....")
